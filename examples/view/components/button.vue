  ...
  <c-article>
    <article>
      ...
      <Demo id="BASE">
        ...
        <span slot="title" class="title">按钮类型</span>
        <div slot="desc">
          <p>按钮类型有：默认按钮、主按钮、禁用按钮以及四种颜色按钮。</p>
          <p>
            通过 <code>type</code>为 <code>primary</code>、
            <code>success</code>、 <code>info</code>、 <code>warning</code>、
            <code>error</code> 创建不同颜色的按钮, 默认<code>default</code>
          </p>
        </div>
        <code-demo lang="html" slot="code">{{ ButtonDoc.base }}</code-demo>
      </Demo>
      <Demo id="CIRCLE">
        <div slot="case">
          <c-button type="primary" icon="search">Search</c-button>
          <c-button type="primary" round icon="search">Round</c-button>
          <c-button type="primary" circle>
            <c-icon name="search"></c-icon>
          </c-button>
        </div>
        <span slot="title" class="title">图标按钮及按钮形状</span>
        <div slot="desc">
          <p>
            使用<code>Button</code>组件的<code>icon</code>可实现文字带图标的状态,
            在当前<code>icon</code>可不需传入完整名字，只需传入最后的关键词
          </p>
          <p>通过设置属性<code>round</code>可设置胶囊按钮</p>
          <p>
            通过设置属性<code>circle</code>用于展示<code>icon</code>,切勿传入文字
          </p>
        </div>
      ...
      <Demo id="GROUP">
        ...
        <span slot="title" class="title">组合式按钮</span>
        <div slot="desc">
          <p>
            通过<code>ButtonGroup</code>组件对<code>button</code>组件进行包裹,
            可实现按钮组合的效果
          </p>
          <p>
            通过设置<code>ButtonGroup</code>的<code>circle</code>可设置按钮组样式为圆角
          </p>
        </div>
      ...
      <Demo id="SIZE">
        ...
        <span slot="title" class="title">按钮大小</span>
        <div slot="desc">
          <p>
            通过设置属性<code>size</code>为<code>large</code>、<code>small</code>可设置组件大小,
            默认组件大小是(中)
          </p>
        </div>
      ...
      <div id="API">
        <api-table
          title="API"
          sub-title="Button props"
          :doc="ButtonDoc.doc"
        ></api-table>
        <api-table
          sub-title="ButtonGroup props"
          :doc="ButtonDoc.groupDoc"
        ></api-table>
      </div>
    </article>
  </c-article>
...
<script>
import ButtonDoc from "../../doc/button.js";
